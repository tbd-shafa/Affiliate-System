                            ...
                            @forelse ($referredUsers as $user)
                                <tr class="border-t border-gray-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $user->email }}
                                     ...
                                     <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $user->created_at->format('Y-m-d') }}
                                    </td>
                                    
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">No Refered users
                                        found.</td>
                                </tr>
                            @endforelse
                        </tbody>
